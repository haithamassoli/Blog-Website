        ...
        <div class="inner">
            ...
            <form id="signup_form">
                ...
                <div class="form-wrapper">
                    <input type="text" placeholder="Username" class="form-control" id="signup_input_username" name="name" required autofocus>
                ...
                <button id="signUp_insignup_btn" type="click" name="btn">Register
